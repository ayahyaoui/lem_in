...
def print_header(one, buff):
        ...
        print '|        \033[1;33mcall _ft_memalloc - \033[1;32m' + str(count) + ' of '\
        ...
        print '| \033[1;32m[call _ft_memalloc] ' + one[:2] + ' ' + one[2:4] + ' ' \
...
def get_symbols():
        ...
        os.system("/usr/bin/otool -tVj " + prog_name + " | grep ft_memalloc > .sym_logs")
        with open(".sym_logs", "r") as fo:
            for line in fo:
                    splitted = line.split()
                    for elem in splitted:
                        if elem == "_ft_memalloc":
                            valid.append(line)
        get_opcodes(valid)
