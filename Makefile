...
#    Updated: 2019/01/16 15:21:14 by emuckens         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
_SRC	= debug.c display.c display_options.c display_moves.c env.c error.c file.c free.c \
	parse_ants.c parse_comments.c parse_rooms.c parse_tubes.c initial.c scan.c  versionopti.c\
